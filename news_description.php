            ...
            <div class="content">                
				...
				<!-- box -->
				    ...
				    <!-- box title-->
												<?php
												$idd=$_GET['id'];
												 $sql="select * from news where id='".$idd."'";
						$query=mysql_query($sql);
						$fetch=mysql_fetch_assoc($query);?>

					    					    <h3><a href="#" title="" >News</a></h3>
												<h1><?php echo $fetch['tittle'];?><br /></h1>
												
	<div class="imgarea"><a href="#" title="" ><img src="news_image/<?php echo $fetch['image'];?>" width="400px" height="200px" alt="" class="alignleft featured_image preload png" /></a></div>
