            ...
            <div class="content">                
				...
				<!-- box -->
					...
					<div class="box single">
					    					    ...
					    					    <!-- box title-->
												<?php $sql="select * from pages where id='12'";
						...
						$fetch=mysql_fetch_assoc($query);?>
						    ...
						    <div class="imgarea"><a href="#" title="" ><img src="page_image/<?php  echo $fetch['image'];?>" width="400px" height="200px" alt="" class="alignleft featured_image preload png" /></a></div>
