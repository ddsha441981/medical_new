...
$sql="insert into pages set name='".$_POST['name']."',description='".$_POST['description']."',image='".$_FILES['image']['name']."',status='1',created='".date('m-d-y')."'";
$my=mysql_query($sql);
